...
model = SimpleMLP(input_dim=3072, hidden_dims=[1024,512,256,128], num_classes=10).to(device)
# model = SimpleMLP(input_dim=3072, hidden_dims=[1024, 1024, 512, 256, 128], num_classes=10).to(device)
